...
public:
    ...
    /**
     * Set the native sample rate of the game.
     * @param sample_rate The sample rate.
     */
    void SetNativeSampleRate(unsigned int sample_rate);
    ...
    /**
     * Set the number of channels the game uses.
     * @param sample_rate The number of channels.
     */
    void SetNumChannels(u32 num_channels);
     ...
     */
    void AddSamples(const s16* buffer, size_t num_samples);
