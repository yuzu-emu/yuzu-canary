...
ShaderCacheOpenGL::ShaderCacheOpenGL(RasterizerOpenGL& rasterizer, Core::System& system,
    ...
    : RasterizerCache{rasterizer}, emu_window{emu_window}, disk_cache{system} {}
...
void ShaderCacheOpenGL::LoadDiskCache(const std::atomic_bool& stop_loading,
    ...
    const auto Worker =
        [&](Core::Frontend::GraphicsContext* context, std::size_t begin, std::size_t end,
            const std::vector<ShaderDiskCacheUsage>& shader_usages,
            const std::unordered_map<ShaderDiskCacheUsage, ShaderDiskCacheDump>& dumps) {
            context->MakeCurrent();
