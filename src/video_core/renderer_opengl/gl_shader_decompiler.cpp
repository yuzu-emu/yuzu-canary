    ...
    u32 CompileInstr(u32 offset) {
        ...
        case OpCode::Type::Arithmetic: {
            ...
            case OpCode::Id::FMUL_IMM: {
                ...
                op_b = GetOperandAbsNeg(op_b, false, instr.alu.negate_a);
            ...
            case OpCode::Id::MUFU: {
                // MUFU only has 'abs' and 'neg' bits for the second operand.
                op_b = GetOperandAbsNeg(op_b, instr.alu.abs_a, instr.alu.negate_a);
                switch (instr.sub_op) {
                case SubOp::Cos:
